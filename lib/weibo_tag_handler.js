...
(function() {
  var date_utils, env, fetch_tags_weibo_score, http, jsdom, logger, mysql, options, request, single_tag_weibo_rank, sprintf, update_all_tags_weibo_score;
        ...
        while (true) {
          ...
          mysql.query(get_tag_sql, null, function(err, results) {
            if (err) {
              ...
              return http.get("http://localhost:8888/single_tag_weibo_rank?tag=" + results[0].name, function(res) {
                completed_count++;
