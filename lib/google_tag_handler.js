...
(function() {
  var calc_top_hundred_score, env, fetch_tags_google_score, http, jsdom, logger, mysql, options, request, single_tag_google_rank, sprintf, update_all_tags_google_score;
  ...
  fetch_tags_google_score = function(response, query) {
                ...
                _results.push(mysql.query(get_tag_sql, null, function(err, tag_results) {
                  ...
                  if (err) {
                    ...
                    mysql.query(get_proxy_sql, null, function(err, results) {
                      ...
                      if (err) {
                        return console.error("[mysql_error:fetch_tags_google_score] can't find available proxy by " + err);
                      } else {
                        ...
                        return request.get({
                          ...
                          if (completed_count >= tags_total_count) {
                            return update_all_tags_google_score();
                          }
                        });
                      }
                    });
  ...
  update_all_tags_google_score = function() {
    ...
    return mysql.query(update_tags_score_sql, null, function(err, results) {
      if (err) {
        return console.log("[mysql error] update tags google score failed for " + err);
      } else {
        return console.log("tags google score updated");
      }
    });
  };

  single_tag_google_rank = function(response, query) {
