...
(function() {
  var calc_top_hundred_score, env, fetch_tags_soso_score, http, jsdom, logger, mysql, options, request, single_tag_soso_rank, sprintf, update_all_tags_soso_score;
  ...
  fetch_tags_soso_score = function(response, query) {
                ...
                _results.push(mysql.query(get_tag_sql, null, function(err, tag_results) {
                  ...
                  if (err) {
                    ...
                    mysql.query(get_proxy_sql, null, function(err, results) {
                      ...
                      if (err) {
                        return console.error("[mysql_error:fetch_tags_soso_score] can't find available proxy by " + err);
                      } else {
                        ...
                        return request.get({
                          ...
                          if (completed_count >= tags_total_count) {
                            return update_all_tags_soso_score();
                          }
                        });
                      }
                    });
  ...
  update_all_tags_soso_score = function() {
    ...
    return mysql.query(update_tags_score_sql, null, function(err, results) {
      if (err) {
        return console.log("[mysql error] update tags soso score failed for " + err);
      } else {
        return console.log("tags soso score updated");
      }
    });
  };

  single_tag_soso_rank = function(response, query) {
