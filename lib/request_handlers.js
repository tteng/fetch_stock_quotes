...
(function() {
  var Memcached, env, fetch_stocks, http, logger, memcached, mysql, options, quotes, request, sprintf, start;
  ...
  quotes = function(response, query) {
  ...
  fetch_stocks = function(response, query) {
        ...
        while (true) {
          ...
          mysql.query(get_tickers_sql, null, function(err, results) {
            ...
            if (err) {
              ...
              return http.get("http://localhost:8888/quotes?stock=" + (stock_tickers.join(',')), function(res) {}).on('error', function(e) {
