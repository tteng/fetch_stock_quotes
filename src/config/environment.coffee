...
settings =
  ...
  # 中文测试代理是否工作的热门关键词
  CHINESE_HOT_KEYS: ["同学", "李天一", "李双江", "小霸王", "逛街", "足球", "篮球", "彩票", "出租车", "今天", "相亲", "吃饭", "出门", "帅哥", "美女", "视频", "故事", "车", "房子", "儿子", "女儿", "工资", "国家", "报纸", "广播", "图片", "博客", "活动", "应用", "315", "大众", "DSG", "奔驰", "维权", "红十字会", "郭美美"]

  redisPort: 6379

  redisHost: "127.0.0.1"

  redisNamespace: "thrack"
